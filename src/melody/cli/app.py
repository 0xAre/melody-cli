...
from melody.cli.commands import config, convert, download, fix, history, report, search
...
app.add_typer(report.app,  name="report",   help="Laporkan bug ke GitHub Issues")
